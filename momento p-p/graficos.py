...
def montar(nome_arquivo,eixox='X',eixoy='Y',bins=100,intervaloa=-10,intervalob=10):
    ...
    hist = ROOT.TH1F('hist',nome_arquivo[5:-4],bins,intervaloa,intervalob)
    ...
    hist.Draw()
    #c.Draw()
    n = 'fig/grafico_'+nome_arquivo[5:-4]
    c.SaveAs(n+".png")
